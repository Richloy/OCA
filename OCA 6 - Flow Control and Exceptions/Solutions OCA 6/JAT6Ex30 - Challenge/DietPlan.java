...
public class DietPlan{
	...
	public void presentMenu(){
	  ...
	  System.out.println("999 To View the Menu");
      System.out.println("0: To Exit"); // ***************
	  System.out.println("1: To View Meals Selected.");
	  ...
	  for (HealthyFood hf:foods){
		System.out.println(++counter + ": " +hf.toString() + " calories.");
	  }// loop
	...
	public void processSelection(){
		...
		int sentinel = 1; // user selection
		 ...
		 outer: do{
		  ...
		  if(sentinel == 1) { // user wishes to view the meals selected to date.
